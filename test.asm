...
.data
mang_so: 	.byte 	63, 6,  91, 79, 102, 109 ,125, 7, 127, 111	 # tu 0 den 9 (nhi phan)
string: 	.asciiz "bach khoa ha noi" 
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.text	# Cac bien toan cuc : k0, k1, s0, s1, s2, s3, s4, s5, a1
MAIN:	li	$k0,  KEY_CODE              
	li  	$k1,  KEY_READY
...
kiem_tra_ky_tu:					# Kiem tra ky tu nhap vao
	...
	beq 	$t1, 8, kiem_tra_backspace	# Neu ki tu nhap vao la backspace thi phai kiem tra lai
...
kiem_tra_backspace:
	...
	addi 	$s1, $s1, 1
check1:
	bne 	$s4, ' ', check2		# Neu ky tu truoc do la ' ' thi phai giam bien dem so tu da nhap di 1
